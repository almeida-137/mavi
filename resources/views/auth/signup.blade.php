                            ...
                            <div class="position-absolute w-40 top-0 start-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8"
                                    ...
                                    <div class="text-start position-absolute fixed-bottom ms-7">
                                        <h6 class="text-white text-sm mb-5">Copyright © 2024 MaVi System</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    ...
                                    <p class="mb-0">Prazer em conhecê-lo! Por favor, insira suas informações.</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="sign-up">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" id="name" name="name" class="form-control"
                                                placeholder="Insira seu nome" value="{{old("name")}}" aria-label="Name"
                                        ...
                                        <div class="mb-3">
                                            <input type="email" id="email" name="email" class="form-control"
                                                placeholder="Insira seu e-mail" value="{{old("email")}}" aria-label="Email"
                                        ...
                                        <div class="form-check form-check-info text-left mb-0">
                                            ...
                                            <label class="font-weight-normal text-dark mb-0" for="terms">
                                                Eu aceitos os <a href="javascript:;"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <button type="button" class="btn btn-white btn-icon w-100 mb-3">
                                                ...
                                                <span class="btn-inner--text">Cadastrar-se com Google</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
