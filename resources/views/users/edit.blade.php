                        ...
                        <div class="card-body">
                            <form action="{{ route('users.update', $user->id) }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" 
                                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="{{ old('email', $user->email) }}" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" 
                                            ...
                                            placeholder="(99)99999-9999" value="{{ old('phone', $user->phone) }}" required>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="user_type" name="user_type" required>
                                            <option value="customer" {{ $user->user_type == 'customer' ? 'selected' : '' }}>Cliente</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="company_id" name="company_id" value="{{ old('company_id', $user->company_id) }}">
                                </div>
